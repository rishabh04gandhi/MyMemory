...
import com.rishabhg4.mymemory.utils.*
...
class CreateActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val PICK_PHOTO_CODE = 497
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(clipData != null) {
            Log.i(TAG, "clip numImages ${clipData.itemCount}: $clipData")
    ...
    private fun saveDataToFirebase() {
        ...
        // Check that we're not overwrititng someone else's data
